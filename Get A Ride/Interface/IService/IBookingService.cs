...
namespace GetARide.Interface.IService
{
    ...
    {
        public Task<BaseResponse> CreateBooking(BookingRequestModel model, CancellationToken cancellationToken);
        public Task<BaseResponse> CancelBooking(string referenceNumber, CancellationToken cancellationToken);
        public Task<BaseResponse> AcceptBooking(string referenceNumber, CancellationToken cancellationToken);
        public Task<BaseResponse> RejectBooking(string referenceNumber, CancellationToken cancellationToken);
